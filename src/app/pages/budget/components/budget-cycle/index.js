...
const BudgetCycle = () => (
  <ContentSection id="budget-cycle-introduction" title="El ciclo del presupuesto">
    <p>El presupuesto del Estado pasa por distintas etapas, antes, durante y después de lo que se suele denominar
      ...
      presupuesto.</p>
    <p>En cada una de esas etapas, diferentes organismos generan distintos documentos en los que se encontrará buena
      parte de la información necesaria para nuestro análisis. Las distintas fases de un ciclo presupuestario completo
      pueden resumirse del siguiente modo</p>
  </ContentSection>
);
