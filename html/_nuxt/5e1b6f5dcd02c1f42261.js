(window.webpackJsonp = window.webpackJsonp || []).push([
    [4], {
        ...
        176: function(t, e, a) {
                ...
                r = (a(44), {
                    ...
                    methods: {
                        createSvgElements: function() {
                            this.svg = i.p("#evolutionSearch"), this.g = this.svg.append("g").attr("transform", "translate(".concat(this.margin.left, ", ").concat(this.margin.top, ")")), this.g.append("g").attr("class", "x axis").append("text").attr("class", "label"), this.g.append("g").attr("class", "y axis").append("text").attr("class", "label"), this.g.append("g").attr("class", "y grid")
                        },
                        setSvgSize: function() {
                        ...
                        draw: function() {
                            var t = this,
                                e = i.n().range([0, this.svgSize.width]).domain(i.e(this.data, function(t) {
                            ...
                            for (var o = i.n().range([this.svgSize.height, 0]).domain(i.e(a)).nice(), r = function(a) {
                                    var r = t.data.filter(function(t) {
                                        return t.group === a
                                    });
                                    r.sort(function(t, e) {
                                        return t.ejercicio_presupuestario - e.ejercicio_presupuestario
                                    }), t.plotLines(r, e, o, "grupo-" + String(a), "credito_vigente", i.o[a - 1]), t.plotDots(r, e, o, "grupo-" + String(a), "credito_vigente", i.o[a - 1])
                                }, s = 1; s <= 10; s++) r(s);
                        ...
                        plotLines: function(t, e, a, o, r, s) {
                            var n = 200 * t.length,
                                c = i.k().x(function(t) {
                            ...
                            l.exit().remove();
                            var d = l.enter().append("path").attr("class", "line ".concat(o)).style("stroke", s),
                                u = (l = l.merge(d).attr("d", c)).node().getTotalLength();
                            l.attr("stroke-dasharray", u + " " + u).attr("stroke-dashoffset", u).transition().duration(n).ease(i.c).attr("stroke-dashoffset", 0)
                        },
                        plotDots: function(t, e, a, o, r, s) {
                            var n = 100 * t.length,
                                c = this.g.selectAll(".dot.".concat(o)).data(t);
                            c.exit().remove();
                            var l = c.enter().append("circle").attr("class", "dot ".concat(o)).style("fill", s);
            ...
            n.options.__file = "TheLinePlotGroup.vue";
            var c = {
                    data: function() {
                        return {
                            filterBy: "todos",
                    ...
                    components: {
                        TheLinePlotGroup: n.exports
                    },
                    methods: {
                        search: function() {
                            var t = this;
                            "" !== this.words && (this.loading = !0, i.j("".concat(o.a, "/buscar?q=").concat(this.words, "&filtro=").concat(this.filterBy)).then(function(e) {
