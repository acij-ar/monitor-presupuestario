        ...
        175: function(t, e, a) {
                ...
                u = (a(94), {
                    ...
                    methods: {
                        createSvgElements: function() {
                            this.svg = n.o("#treeMap")
                        },
                        setSvgSize: function() {
                            var t = document.getElementsByClassName("column is-12")[0].clientWidth - 24,
                                e = 1 * t / 3;
                            this.svgSize.width = t, this.svgSize.height = e, this.svg.attr("width", t + this.margin.left + this.margin.right).attr("height", e + this.margin.top + this.margin.bottom), this.treemap = n.p().tile(n.q).size([this.svgSize.width, this.svgSize.height]).round(!0).paddingInner(5)
                        },
                        draw: function() {
                            var t = this,
                                e = n.k(this.root.data.children, function(t) {
                            ...
                            this.root.data.children.forEach(function(t) {
                                t.mapValue = (t.credito_presupuestado - a) / (e - a) * .5 + .5
                            });
                            var i = this.svg.selectAll("g").data(this.root.leaves());
                            i.exit().remove();
                            var o = i.enter().append("g");
                            i = i.merge(o).attr("transform", function(t) {
                            ...
                            }), o.append("rect"), i.select("rect").attr("id", function(t) {
                                return t.data.name.replace(/ /g, "_")
                            }).attr("fill", function(t) {
                                return n.h(t.data.mapValue)
                            }).attr("width", 0).attr("height", function(t) {
                                return t.y1 - t.y0
                            }).transition().duration(2e3).attr("width", function(t) {
                                return t.x1 - t.x0
                            }), o.append("clipPath"), i.select("clipPath").attr("id", function(t) {
                                return "clip-" + t.data.name.replace(/ /g, "_")
                            }).append("use").attr("xlink:href", function(t) {
                                return "#" + t.data.name.replace(/ /g, "_")
                            }), i.select("text").remove(), i.append("text").attr("clip-path", function(t) {
                        ...
                        mouseover: function(t) {
                            ...
                            var e = "";
                            t.data.programa_id && (e = "<strong>Programa:</strong> ".concat(t.data.programa_desc, "<br />\n        <strong>Programa ID:</strong> ").concat(t.data.programa_id)), n.o("#tooltip").style("left", n.d.pageX - 125 + "px").style("top", n.d.pageY + 20 + "px").html(function() {
                            ...
                            }), n.o("#tooltip").classed("hidden", !1)
                        },
                        mouseout: function(t) {
                            n.o("#tooltip").classed("hidden", !0)
                        }
                    }
                }),
            ...
            var p = d.exports,
                h = {
                    ...
                    methods: {
                        createSvgElements: function() {
                            this.svg = n.o("#evolution"), this.g = this.svg.append("g").attr("transform", "translate(".concat(this.margin.left, ", ").concat(this.margin.top, ")")), this.g.append("g").attr("class", "x axis").append("text").attr("class", "label"), this.g.append("g").attr("class", "y axis").append("text").attr("class", "label"), this.g.append("g").attr("class", "y grid")
                        },
                        setSvgSize: function() {
                            var t = document.getElementsByClassName("column is-12")[0].clientWidth - 24,
                                e = 1 * t / 3;
                        ...
                        draw: function() {
                            var t = n.m().range([0, this.svgSize.width]).domain(n.e(this.data, function(t) {
                            ...
                            var a = n.m().range([this.svgSize.height, 0]).domain(n.e(e)).nice();
            ...
            var w = {
                    ...
                    methods: {
                        getDataTree: function(t) {
                            var e, a, o, r = this;
                            0 === this.treeDeep ? (o = "root", a = "jurisdiccion_desc", e = "".concat(i.a, "/jurisdiccion?anio=").concat(this.selectedYear)) : (o = t, a = "programa_desc", e = "".concat(i.a, "/programa/").concat(t, "?anio=").concat(this.selectedYear)), n.i(e).then(function(t) {
                        ...
                        getDataEvolution: function(t, e, a) {
                            var o, r = this;
                            o = 0 === this.treeDeep ? "".concat(i.a, "/jurisdiccion?juri_nombre=").concat(t) : "".concat(i.a, "/programa/").concat(e, "?prog_id=").concat(a), n.i(o).then(function(e) {
